 ...
 * @since 1.0.0
 */
@Slf4j(topic = "TaLuoPaiZhanBuGuaHandler")
public class TaLuoPaiZhanBuGuaHandler {

    // 定义关键词数组（建议声明为常量）
    private static final String[] CESUAN_KEYWORDS = {"基本信息", "解牌含义", "牌面建议"};
    ...
    public static void handle(CesuanContext ctx) {
        ...
        String result = HttpUtil.post(StrUtil.format(url, RandomUtil.randomInt(1, 23)),"{}");
        // 解析 HTML 字符串
